        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Class Informaion</h4>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                       ...
                       <!-- <label class="col-sm-3">Class Name</label> -->
                          <div class="col-sm-9">
                            <input type="text" class="form-control" placeholder="Enter Your class Name" name = "class_name" />
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                            <div class="form-group row">
                            <button type="submit" class="btn btn-primary btn-fw" name = "create">Create</button>
                            </div>
                      </div>      
            ...
            <?php foreach($Results as $Class) {  ?>          
                      ...
                      <form action="" method="post">  
                        ...
                        <td>
                              ...
                              <input type="hidden" name ="id_delete" value ="<?php echo $Class['id']; ?>">
                          <a href ="EditClass.php?id=<?php echo $Class['id']; ?>" class="btn btn-warning btn-icon-text" name ="Edit">
                            <i class="mdi mdi-border-color btn-icon-prepend"></i> Edit </a>

                            <button type="submit" name ="deleteClass" class="btn btn-danger btn-icon-text">
